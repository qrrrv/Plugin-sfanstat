...
KEYWORDS_URL = "https://raw.githubusercontent.com/qrrrv/Fanstat-plugin/main/pierce_hunter_keywords.txt"
DEFAULT_TARGET = "@telelogpidr_bot"
...
class Plugin(BasePlugin):
    ...
    def create_settings(self):
        return [
            ...
            Input(
                ...
                subtext="Можно @username бота или числовой peer id.",
            ),
            Input(
    ...
    def _handle_command(self, peer, message):
        ...
        if action == "rand":
            ...
            send_text(peer, "❌ Команда не распознана. Напиши .pierce help")
    ...
    def on_send_message_hook(self, account, params):
        ...
        if not isinstance(text, str):
            return HookResult()
        msg = text.strip()
        if not msg.lower().startswith(".pierce"):
            return HookResult()
